...
public class TimeseriesClientImpl
        implements TimeseriesClient
{
    ...
    public List<Header> getTimeseriesHeaders()
    {
        ...
        this.wsClient.addZoneIdToHeaders(headers, this.timeseriesConfig.getZoneId());
    ...
    {
        this.wsClient.addZoneIdToHeaders(headers, zoneId);
        headers.add(new BasicHeader("Origin", "http://localhost")); //$NON-NLS-2$
        return headers;
    }
    ...
    {
        return this.wsClient.addSecureTokenToHeaders(headers);
    }

    @Override
    public List<Header> addSecureTokenToHeaders(List<Header> headers, String token) {
        this.wsClient.addSecureTokenToHeaders(headers, token);
        return headers;
    }
}
